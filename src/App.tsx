          ...
          <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl">
              ...
              <a
                href="#/vanity"
                target="_blank"
                className={`flex items-center gap-2 px-5 py-2 text-sm font-medium rounded-lg transition-all cursor-pointer bg-amber-50 text-amber-700 hover:bg-amber-100`}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
