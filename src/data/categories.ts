    ...
    subCategories: [
      {
        id: 'wood-grain-tile',
        name: '木纹砖',
        specs: [{ value: 'matte', label: '哑光' }, { value: 'glossy', label: '亮光' }, { value: 'antique', label: '仿古' }],
        colors: ['白色', '米色', '灰色', '深灰', '棕色', '木色'],
        sizes: ['150x600mm', '200x1000mm', '150x800mm', '200x800mm'],
        unit: '平方米',
        filterGroups: [
          { key: 'spec', label: '表面处理', type: 'tag', options: [{ value: '哑光', label: '哑光' }, { value: '亮光', label: '亮光' }, { value: '仿古', label: '仿古' }] },
          { key: 'color', label: '颜色', type: 'color', options: [{ value: '白色', label: '白色', colorHex: '#f9fafb' }, { value: '米色', label: '米色', colorHex: '#fef3c7' }, { value: '灰色', label: '灰色', colorHex: '#9ca3af' }, { value: '深灰', label: '深灰', colorHex: '#4b5563' }, { value: '棕色', label: '棕色', colorHex: '#92400e' }, { value: '木色', label: '木色', colorHex: '#d97706' }] },
          { key: 'size', label: '尺寸', type: 'tag', options: [{ value: '150x600mm', label: '150×600' }, { value: '200x1000mm', label: '200×1000' }, { value: '150x800mm', label: '150×800' }, { value: '200x800mm', label: '200×800' }] },
        ],
      },
      {
        id: 'polished-tile',
        name: '抛光砖',
        specs: [{ value: 'super-glossy', label: '超亮' }, { value: 'semi-glossy', label: '半亮' }],
        colors: ['白色', '米白', '灰白', '米黄', '浅灰'],
        sizes: ['600x600mm', '800x800mm', '1000x1000mm', '1200x1200mm'],
        unit: '平方米',
        filterGroups: [
          { key: 'spec', label: '光泽度', type: 'tag', options: [{ value: '超亮', label: '超亮' }, { value: '半亮', label: '半亮' }] },
          { key: 'color', label: '色调', type: 'color', options: [{ value: '白色', label: '白色', colorHex: '#f9fafb' }, { value: '米黄', label: '米黄', colorHex: '#fbbf24' }, { value: '浅灰', label: '浅灰', colorHex: '#d1d5db' }] },
          { key: 'size', label: '规格', type: 'tag', options: [{ value: '600x600mm', label: '600×600' }, { value: '800x800mm', label: '800×800' }, { value: '1000x1000mm', label: '1000×1000' }, { value: '1200x1200mm', label: '1200×1200' }] },
        ],
      },
      {
        id: 'wall-tile',
        name: '墙砖',
        specs: [{ value: 'glossy', label: '亮光' }, { value: 'matte', label: '哑光' }, { value: '3d', label: '3D浮雕' }],
        colors: ['白色', '浅灰', '米色', '深色', '彩色'],
        sizes: ['300x600mm', '300x450mm', '250x400mm', '400x800mm'],
        unit: '平方米',
        filterGroups: [
          { key: 'spec', label: '表面效果', type: 'tag', options: [{ value: '亮光', label: '亮光' }, { value: '哑光', label: '哑光' }, { value: '3D浮雕', label: '3D浮雕' }] },
          { key: 'color', label: '颜色', type: 'color', options: [{ value: '白色', label: '白色', colorHex: '#f9fafb' }, { value: '浅灰', label: '浅灰', colorHex: '#d1d5db' }, { value: '米色', label: '米色', colorHex: '#fef3c7' }] },
          { key: 'size', label: '尺寸', type: 'tag', options: [{ value: '300x600mm', label: '300×600' }, { value: '300x450mm', label: '300×450' }, { value: '400x800mm', label: '400×800' }] },
        ],
      },
      {
        id: 'floor-tile',
        name: '地砖',
        specs: [{ value: 'non-slip', label: '防滑' }, { value: 'polished', label: '抛光' }, { value: 'full-polished', label: '全抛釉' }],
        colors: ['深灰', '浅灰', '米色', '棕色', '黑色'],
        sizes: ['600x600mm', '800x800mm', '600x1200mm', '900x900mm'],
        unit: '平方米',
        filterGroups: [
          { key: 'spec', label: '工艺', type: 'tag', options: [{ value: '防滑', label: '防滑' }, { value: '抛光', label: '抛光' }, { value: '全抛釉', label: '全抛釉' }] },
          { key: 'color', label: '颜色', type: 'color', options: [{ value: '深灰', label: '深灰', colorHex: '#4b5563' }, { value: '浅灰', label: '浅灰', colorHex: '#d1d5db' }, { value: '米色', label: '米色', colorHex: '#fef3c7' }, { value: '黑色', label: '黑色', colorHex: '#111827' }] },
          { key: 'size', label: '规格', type: 'tag', options: [{ value: '600x600mm', label: '600×600' }, { value: '800x800mm', label: '800×800' }, { value: '600x1200mm', label: '600×1200' }] },
        ],
      },
    ],
  },
...
export const SAMPLE_PRODUCTS: StandardProduct[] = [
  // 陶瓷 - 木纹砖（多供应商示例）
  { 
    id: 'p001',  libraryId: 'LIB-2024-0001', 
    categoryId: 'ceramic', subCategoryId: 'wood-grain-tile', 
    name: '北欧轻奢木纹砖',   spec: '哑光',    color: '木色', size: '200x1000mm', unit: '平方米', moq: 100, 
    basePrice: 28.5, 
    imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop', 
    length: 200, width: 1000, height: 10, weight: 18, 
    description: '高档哑光木纹砖，适合客厅卧室，现代简约风格',
    // 多供应商价格
    supplierPrices: [
      { supplierId: 's001', supplierProductId: 'HD-WGT-200A', price: 28.5, moq: 100, leadTime: '15天' },
      { supplierId: 's011', supplierProductId: 'HY-WGT-200X', price: 26.8, moq: 120, leadTime: '20天' },
      { supplierId: 's012', supplierProductId: 'XZ-WGT-200Pro', price: 29.5, moq: 80, leadTime: '12天', remark: '优等品' },
    ],
  },
  { id: 'p001b', libraryId: 'LIB-2024-0002', supplierProductId: 'DP-WGT-150B',  categoryId: 'ceramic', subCategoryId: 'wood-grain-tile', supplierId: 's002', name: '灰橡木纹砖',     spec: '哑光',    color: '灰色', size: '150x600mm',  unit: '平方米', moq: 100, basePrice: 24.8, imageUrl: 'https://images.unsplash.com/photo-1612833603922-5b2b91cb4b62?w=400&h=300&fit=crop', length: 150, width: 600, height: 9, weight: 14, description: '灰橡木纹瓷砖，自然纹理，哑光表面' },
  { id: 'p001c', libraryId: 'LIB-2024-0003', supplierProductId: 'HD-WGT-200C',  categoryId: 'ceramic', subCategoryId: 'wood-grain-tile', supplierId: 's001', name: '复古棕木纹砖',   spec: '仿古',    color: '棕色', size: '200x1000mm', unit: '平方米', moq: 80,  basePrice: 32.0, imageUrl: 'https://images.unsplash.com/photo-1596395147635-c90bcd2c2a4f?w=400&h=300&fit=crop', length: 200, width: 1000, height: 10, weight: 19, description: '复古风格仿古木纹砖，棕色调，营造温馨氛围' },
  { id: 'p001d', libraryId: 'LIB-2024-0004', supplierProductId: 'DP-WGT-150D',  categoryId: 'ceramic', subCategoryId: 'wood-grain-tile', supplierId: 's002', name: '浅米色木纹砖',   spec: '亮光',    color: '米色', size: '150x800mm',  unit: '平方米', moq: 120, basePrice: 26.5, imageUrl: 'https://images.unsplash.com/photo-1565182999561-18d7dc61c393?w=400&h=300&fit=crop', length: 150, width: 800, height: 10, weight: 15, description: '浅米色亮光木纹砖，温馨明亮，适合小户型' },
  // 陶瓷 - 抛光砖
  { id: 'p002',  libraryId: 'LIB-2024-0005', supplierProductId: 'HD-PT-800A',   categoryId: 'ceramic', subCategoryId: 'polished-tile',   supplierId: 's001', name: '超白抛光砖',     spec: '超亮',    color: '白色', size: '800x800mm',    unit: '平方米', moq: 200, basePrice: 22.0, imageUrl: 'https://images.unsplash.com/photo-1615971677499-5467cbab01c0?w=400&h=300&fit=crop', length: 800, width: 800, height: 12, weight: 35, description: '超白抛光瓷砖，亮度高，适合大厅商场' },
  { id: 'p002b', libraryId: 'LIB-2024-0006', supplierProductId: 'DP-PT-1200B',  categoryId: 'ceramic', subCategoryId: 'polished-tile',   supplierId: 's002', name: '米黄大板抛光砖', spec: '半亮',    color: '米黄', size: '1200x1200mm',  unit: '平方米', moq: 150, basePrice: 38.0, imageUrl: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400&h=300&fit=crop', length: 1200, width: 1200, height: 13, weight: 52, description: '大规格米黄抛光砖，1200x1200大板，高端大气' },
  // 陶瓷 - 墙砖
  { id: 'p002c', libraryId: 'LIB-2024-0007', supplierProductId: 'HD-WT-300A',   categoryId: 'ceramic', subCategoryId: 'wall-tile',       supplierId: 's001', name: '小白砖地铁砖',   spec: '亮光',    color: '白色', size: '300x600mm',  unit: '平方米', moq: 200, basePrice: 15.5, imageUrl: 'https://images.unsplash.com/photo-1517581177682-a085bb7ffb15?w=400&h=300&fit=crop', length: 300, width: 600, height: 8, weight: 12, description: '经典小白砖/地铁砖，亮光白，厨房卫生间首选' },
  { id: 'p002d', libraryId: 'LIB-2024-0008', supplierProductId: 'DP-WT-300B',   categoryId: 'ceramic', subCategoryId: 'wall-tile',       supplierId: 's002', name: '3D浮雕艺术墙砖', spec: '3D浮雕',  color: '白色', size: '300x450mm',  unit: '平方米', moq: 100, basePrice: 42.0, imageUrl: 'https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=400&h=300&fit=crop', length: 300, width: 450, height: 10, weight: 10, description: '3D浮雕艺术墙砖，立体感强，装饰效果极佳' },
  // 陶瓷 - 地砖
  { id: 'p002e', libraryId: 'LIB-2024-0009', supplierProductId: 'HD-FT-600A',   categoryId: 'ceramic', subCategoryId: 'floor-tile',      supplierId: 's001', name: '深灰防滑地砖',   spec: '防滑',    color: '深灰', size: '600x600mm',  unit: '平方米', moq: 200, basePrice: 19.8, imageUrl: 'https://images.unsplash.com/photo-1604082787521-6d13ab63dadb?w=400&h=300&fit=crop', length: 600, width: 600, height: 10, weight: 25, description: '深灰色防滑地砖，耐磨防滑，适合卫生间阳台' },
  // 卫浴 - 马桶
